...
/// <summary>Provides immutable options for a <see cref="BroadcastPipe"/>.</summary>
public class BroadcastPipeOptions
{
    ...
    public static BroadcastPipeOptions Default { get; } = new();
    ...
    public BroadcastPipeOptions(
        ...
        BroadcastPipeReaderFailureBehavior readerFailureBehavior = BroadcastPipeReaderFailureBehavior.Continue)
    {
    ...
    public BroadcastPipeReaderFailureBehavior ReaderFailureBehavior { get; }
