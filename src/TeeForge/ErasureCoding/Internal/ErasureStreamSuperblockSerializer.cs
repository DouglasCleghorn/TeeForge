...
internal static class ErasureStreamSuperblockSerializer
{
    ...
    internal static void Write(ErasureStreamHeader header, Span<byte> destination)
    {
        Validate(header);
    ...
    internal static bool TryRead(ReadOnlySpan<byte> source, out ErasureStreamHeader? header)
    {
        header = null;
        ...
        var candidate = new ErasureStreamHeader(
    ...
    private static void Validate(ErasureStreamHeader header)
    {
