...
public enum ErasureCodeStreamStatus
{
...
public sealed class ErasureCodeStreamState
{
    internal ErasureCodeStreamState(
        DateTimeOffset observedAt,
        ErasureCodeStreamStatus status,
        bool isReadOnly,
        bool canRead,
        bool canWrite,
        int readQuorum,
    ...
    public ErasureCodeStreamStatus Status { get; }
...
public sealed class ErasureCodeStreamStateChangedEventArgs : EventArgs
{
    internal ErasureCodeStreamStateChangedEventArgs(
    ...
    public ErasureCodeStreamState Previous { get; }

    /// <summary>Gets the snapshot after the transition.</summary>
    public ErasureCodeStreamState Current { get; }
}
