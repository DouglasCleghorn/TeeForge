...
public class DifferencingStream : Stream, ITeeRandomAccessStream, ITeeRangeReadSource,
    IVirtualDiskStream, IDependentStreamRegistry
{
    ...
    private readonly DifferencingStreamOptions _options;
    ...
    private DifferencingStream(
        Stream baseStream,
        Stream differenceStream,
        DifferencingStreamOptions options)
    {
    ...
    public static DifferencingStreamLocator ReadLocator(Stream differenceStream)
    {
    ...
    public static async ValueTask<DifferencingStreamLocator> ReadLocatorAsync(
        Stream differenceStream,
    ...
    public static DifferencingStream Create(
        Stream baseStream,
        Stream differenceStream,
        DifferencingStreamOptions? options = null,
        ...
        string? parentPathHint = null)
    {
        ArgumentNullException.ThrowIfNull(baseStream);
        ArgumentNullException.ThrowIfNull(differenceStream);
        options ??= DifferencingStreamOptions.Default;
        var stream = new DifferencingStream(baseStream, differenceStream, options);
    ...
    public static ValueTask<DifferencingStream> CreateAsync(
        Stream baseStream,
        Stream differenceStream,
        DifferencingStreamOptions? options = null,
        string? parentPathHint = null,
    ...
    public static DifferencingStream Open(
        Stream baseStream,
        Stream differenceStream,
        DifferencingStreamOptions? options = null)
    {
    ...
    public static ValueTask<DifferencingStream> OpenAsync(
        Stream baseStream,
        Stream differenceStream,
        DifferencingStreamOptions? options = null,
        CancellationToken cancellationToken = default)
    ...
    public override void SetLength(long value) =>
        throw new NotSupportedException("DifferencingStream has an immutable virtual capacity.");
    ...
    private static DifferencingStreamLocator ParseLocator(ReadOnlySpan<byte> identifierBuffer)
    {
        ...
        return new DifferencingStreamLocator(
            identity.BaseId,
    ...
    private void InitializeOpen(StreamIdentity currentBaseIdentity)
    {
        ...
        {
            throw new DifferencingStreamBaseMismatchException(
