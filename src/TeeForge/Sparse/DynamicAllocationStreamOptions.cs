...
/// <summary>Provides immutable options for opening or creating a <see cref="DynamicAllocationStream"/>.</summary>
public class DynamicAllocationStreamOptions
{
    /// <summary>Gets the default options.</summary>
    public static DynamicAllocationStreamOptions Default { get; } = new();
    ...
    public DynamicAllocationStreamOptions(
