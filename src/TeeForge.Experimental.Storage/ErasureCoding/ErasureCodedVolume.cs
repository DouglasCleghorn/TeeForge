...
public class ErasureCodedVolume : Stream, ITeeRandomAccessStream
{
    private readonly Stream[] _suppliedStreams;
    private readonly ErasureCodedVolumeOptions _options;
    ...
    private readonly Dictionary<long, Action<ErasureCodedVolumeStateChangedEventArgs>> _stateHandlers = [];
    private readonly Dictionary<long, Action<ErasureMaintenanceProgress>> _maintenanceHandlers = [];
    private ErasureCodedVolumeState _lastState;
    private long _nextCallbackId;
    private long _position;
    private Exception? _fault;
    private bool _disposed;

    private ErasureCodedVolume(
        Stream[] suppliedStreams,
        ErasureCodedVolumeOptions options,
    ...
    /// <summary>Formats empty member streams and creates an erasure-coded stream.</summary>
    public static async ValueTask<ErasureCodedVolume> CreateAsync(
        IEnumerable<Stream> members,
        int dataShardCount,
        int parityShardCount,
        long logicalCapacity,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        options ??= ErasureCodedVolumeOptions.Default;
        if (options.ReadOnly)
        {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new ErasureCodedVolumeCorruptionException("The erasure set could not be opened safely.", exception);
        }
    ...
    public ErasureCodedVolumeState GetState() => CaptureState();
    ...
    public IDisposable RegisterStateChangeHandler(
        Action<ErasureCodedVolumeStateChangedEventArgs> handler,
        bool invokeImmediately = true)
    {
        ...
        {
            QueueCallback(handler, new ErasureCodedVolumeStateChangedEventArgs(current, current));
        }
    ...
    public override void SetLength(long value) =>
        throw new NotSupportedException("ErasureCodedVolume has a fixed configuration capacity.");
    ...
    private ErasureCodedVolumeState CaptureState()
    {
        ...
        ErasureCodedVolumeStatus aggregate = _disposed
            ? ErasureCodedVolumeStatus.Disposed
            : _fault is not null
                ? ErasureCodedVolumeStatus.Faulted
                : !canRead
                    ? ErasureCodedVolumeStatus.Unavailable
                    : allOnline
                        ? ErasureCodedVolumeStatus.Healthy
                        : ErasureCodedVolumeStatus.Degraded;
        return new ErasureCodedVolumeState(
    ...
    {
        ErasureCodedVolumeState current = CaptureState();
        ErasureCodedVolumeState previous;
        Action<ErasureCodedVolumeStateChangedEventArgs>[] handlers;
        lock (_callbackLock)
        {
            previous = _lastState;
        ...
        var args = new ErasureCodedVolumeStateChangedEventArgs(previous, current);
        foreach (Action<ErasureCodedVolumeStateChangedEventArgs> handler in handlers)
        {
    ...
    private static bool HasEquivalentHealth(
        ErasureCodedVolumeState left,
        ErasureCodedVolumeState right)
    {
    ...
    {
        var exception = new ErasureCodedVolumeCorruptionException(message);
        _fault = exception;
        PublishStateIfChanged();
        throw exception;
    }
    ...
    private void ThrowIfUnavailable()
    {
        ...
        {
            throw new ErasureCodedVolumeCorruptionException("The erasure stream is faulted.", _fault);
        }
    }
