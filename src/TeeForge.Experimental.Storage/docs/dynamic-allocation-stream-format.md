...
The version-1 API consists of an unsealed SparseDiskImage, immutable
SparseDiskImageOptions, DynamicAllocationCompactionMode with Fast and
Slow values, and SparseDiskImageCorruptionException.
