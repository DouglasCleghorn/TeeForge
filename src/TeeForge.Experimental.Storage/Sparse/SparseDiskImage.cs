...
public class SparseDiskImage : Stream, ITeeRandomAccessStream, ITeeRangeReadSource,
    IVirtualDiskStream, IDependentStreamRegistry
{
    private readonly Stream _underlying;
    private readonly ITeeRandomAccessStream? _underlyingRandomAccess;
    private readonly SparseDiskImageOptions _options;
    ...
    private SparseDiskImage(Stream underlying, SparseDiskImageOptions options)
    {
    ...
    public static SparseDiskImage Create(
        Stream underlying,
        long virtualCapacity,
        int blockSize = DynamicAllocationFormat.DefaultBlockSize,
        SparseDiskImageOptions? options = null)
    {
        ArgumentNullException.ThrowIfNull(underlying);
        options ??= SparseDiskImageOptions.Default;
        var stream = new SparseDiskImage(underlying, options);
        stream.InitializeCreate(virtualCapacity, blockSize);
        return stream;
    }

    /// <summary>Creates a new dynamic allocation stream over an empty backing stream.</summary>
    public static ValueTask<SparseDiskImage> CreateAsync(
        Stream underlying,
        long virtualCapacity,
        int blockSize = DynamicAllocationFormat.DefaultBlockSize,
        SparseDiskImageOptions? options = null,
    ...
    public static SparseDiskImage Open(
        Stream underlying,
        SparseDiskImageOptions? options = null)
    {
        ArgumentNullException.ThrowIfNull(underlying);
    ...
    /// <summary>Opens an existing dynamic allocation stream.</summary>
    public static ValueTask<SparseDiskImage> OpenAsync(
        Stream underlying,
        SparseDiskImageOptions? options = null,
        CancellationToken cancellationToken = default)
    {
    ...
    private void StartBackgroundScan()
    {
        _backgroundScan = Task.Run(async () =>
        {
            ...
            catch (SparseDiskImageCorruptionException exception)
            {
    ...
    private void ThrowBackgroundFault()
    {
        ...
        {
            throw new SparseDiskImageCorruptionException(
    ...
    private static SparseDiskImageCorruptionException Corruption(string message, long? offset) =>
        new(message, offset);
