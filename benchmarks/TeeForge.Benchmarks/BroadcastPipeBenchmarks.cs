...
public class BroadcastPipeBenchmarks
{
    ...
    [Benchmark]
    public async Task BroadcastPipeOneReader()
    {
        var pipe = new BroadcastPipe(1, new BroadcastPipeOptions(useSynchronizationContext: false));
    ...
    [Benchmark]
    public async Task BroadcastPipeFourReaders()
    {
        var pipe = new BroadcastPipe(4, new BroadcastPipeOptions(useSynchronizationContext: false));
